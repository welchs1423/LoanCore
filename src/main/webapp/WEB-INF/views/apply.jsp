...
<body>
	<div class="container mt-5">
		...
		<form action="submit-loan" method="post" enctype="multipart/form-data"
			class="card p-4 shadow-sm">
			<div class="mb-3">
				<label class="form-label">고객 ID</label>
				<div class="input-group">
					<input type="text" class="form-control" name="customerId"
						id="customerId" placeholder="CUST-001" required>
					<button type="button" class="btn btn-outline-info"
						onclick="checkCustomerStatus()">진행 상태 검사</button>
				</div>
				<div id="customerCheckResult" class="form-text mt-2"></div>
			</div>

			<div class="mb-3">
				<label class="form-label">신청 금액 (원)</label> <input type="number"
					class="form-control" name="amount" placeholder="50000000" required>
			</div>

			<div class="mb-3">
				<label class="form-label">증빙 서류 첨부</label> <input type="file"
