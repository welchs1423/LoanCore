        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="/LoanCore/logout">로그아웃</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        <c:forEach var="app" items="${recentApps}">
                            <tr>
                                <td><a href="/LoanCore/detail/${app.applicationId}" class="text-decoration-none">${app.applicationId}</a></td>
                        ...
                        <c:if test="${empty recentApps}">
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">최근 신청 내역이 없습니다.</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
